...
const Sidebar = () => {
  ...
  const sideBarClassName = `fixed flex flex-col h-[100%] justify-between shadow-xl transition-all  h-full z-40 dark:bg-black  overflow-y-auto bg-white ${isSidebarCollapsed ? "w-0 hidden" : "w-64"}`;
